...
def get_boxtplot(args):
    ...
    figures_dir = 'boxplots/binomial/baselines/'
    ...
    plt.savefig('boxplots/binomial/baselines/mr_rmse_boxplot.png', bbox_inches='tight', pad_inches=0)
    ...
    # Save the figure with tight bounding box to remove whitespace
    plt.savefig('boxplots/binomial/baselines/mr_bias_boxplot.png',
...
def get_tables(args):
    ...
    for n_samples, df in summary_dfs.items():
        ...
        latex_filename = f"tables/binomial_n_samples_{n_samples}.tex"
...
def get_parameters_experiment(args):
    ...
    with open('sani_experiment_binomial_parameters.csv', mode='w', newline='') as file:
    ...
    print("The CSV file 'sani_experiment_binomial_parameters.csv' has been created.")
